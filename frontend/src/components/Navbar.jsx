            ...
            >
              <div className="relative">
                <span className="absolute inset-0 flex items-center justify-center">
                  <span className="block w-12 h-12 rounded-full bg-white shadow-lg" style={{ opacity: 0.95 }}></span>
                </span>
                <img
                  src="/logo.png"
                  alt="Thermal Polaris Logo"
                  className="w-12 h-12 relative z-10 drop-shadow-glow group-hover:scale-110 transition-transform duration-300"
                />
                <div className="absolute inset-0 bg-primary-500/20 rounded-full blur-xl group-hover:bg-primary-500/40 transition-all duration-300 z-0"></div>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <p className="text-xs text-gray-400 font-medium">
                  Advanced Thermal Vision & Analytics
                </p>
              </div>
            </div>
